...
return [
    'welcome' => "Привет! Я помогу с дедлайнами по отчётности.\n\nКоманды:\n"
        ...
        . "• /tax_history — последние расчёты (Free: 5)\n"
        . "• /setcurrency — валюта компании\n"
        . "• /setrate_default — дефолтная ставка\n"
        . "• /reminders — напоминания\n"
        . "• /plan — план и лимиты\n"
        . "• /features — возможности (вкл. Pro)\n",
    ...
    'addcompany' => [
        ...
        'who' => "Кого регистрируем? Выберите:",
        'type_company' => "Компания (ООО/АО и т.п.)",
        'type_sole_prop' => "ИП",
